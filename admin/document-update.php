                ...
                <section class="content">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="uinputDocTitle">Document Title</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" id="doID" class="d-none" value="<?php echo($doc['id']) ?>" disabled>
                            <a onclick="docUpdateProcess();" class="btn btn-success float-right">Update Document</a>
                        </div>
                    </div>
                </section>
                <!-- /.content -->
