        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./cursol-add.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cursol Add</p>
                </a>
              </li>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./newsAll.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>News All</p>
                </a>
              </li>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./galleryAll.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Gallery All</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./gallery-add.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Gallery Add</p>
                </a>
              </li>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./notice-add.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Notice Add</p>
                </a>
              </li>
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./document-add.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Document Add</p>
                </a>
              </li>
