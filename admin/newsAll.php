...
?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="single-blogAdmin ">
                                    <div class="blog-thumbAdmin" style="background-image: url(<?php echo($news['main-img']) ?>)"></div>
                                    <h4 class="blog-title"><a href="news-single.php?n=<?php echo($news['id']) ?>"><?php echo($news['header']) ?></a></h4>
                                    <p class="blog-meta"><a href="#"><?php echo($news['date']) ?></p>
                                    <p class="truncate"><?php echo($news['content']) ?></p>
