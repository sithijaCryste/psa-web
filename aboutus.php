            ...
            <div class="row justify-content-start">
                <div class="col-lg-12">
                    <div class="section-title text-start">
                        <h1><img src="assets/media/flaticon icons/PSA umb.png" class="umbIcon d-none d-md-inline d-lg-inline" width="42px" alt=""> People’s <span style="color: #ffc900;">Struggle</span> Alliance <img src="assets/media/flaticon icons/PSA umb.png" class="umbIcon d-none d-md-inline d-lg-inline" width="42px" alt=""></h1>
        ...
        <div class="container">
            ...
            <div class="mx-5 row g-2 row-gap-0 text-end ">
                <div class="col-12 col-lg-4 col-md-6 ">
                    ...
                    <p class="text-start"><img src="assets/media/flaticon icons/PSA red umb.png" class="umbIcon m-2" width="18px" alt=""> Frontline Socialist Party</p>
                </div>
                <div class="col-12 col-lg-4 col-md-6 ">

                    <p class="text-start"><img src="assets/media/flaticon icons/PSA red umb.png" class="umbIcon m-2" width="18px" alt=""> New Democratic Marxist-Leninist Party</p>
                </div>
                <div class="col-12 col-lg-4 col-md-6 ">

                    <p class="text-start"><img src="assets/media/flaticon icons/PSA red umb.png" class="umbIcon m-2" width="18px" alt=""> Socialist People's Front</p>
                </div>
