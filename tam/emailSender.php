...
if (empty($name)) {
    ...
    try {
        ...
        if (!$mail->send()) {
            echo 'மின்னஞ்சல் அனுப்ப முடியவில்லை: ' . $mail->ErrorInfo;
        } else {
            echo ("மின்னஞ்சல் வெற்றிகரமாக அனுப்பப்பட்டது");
        }
    } catch (Exception $e) {
        echo 'செய்தியை அனுப்ப முடியவில்லை. Mailer Error: ' . $mail->ErrorInfo;
    }
}
?>
