                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="row d-block">
                            <h3>Recent Post</h3>
                            <?php
$n = "SELECT * FROM `news` ORDER BY `date` DESC LIMIT 3";

$res = Database::search($n);
$num = $res->num_rows;
for($y = 0; $y < $num; $y++ ){
    $gal = $res->fetch_assoc();
...
?>
                    ...
                    <div class="col-lg-2">
                        <div class="row d-block">
                            ...
                            <div class="col-12">
                            <i class="fa-solid fa-circle-dot"></i>  <a href="news.php" class="text-white text-decoration-none">People’s Blog </a>
                            </div>
                            <div class="col-12">
