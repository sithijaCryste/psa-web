            ...
            for ($i = 0; $i < $num2; $i++) {
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="serviceBox boxHov">
                        ...
                        <h3><a href="psa-document.php?d=<?php echo($doc['id']) ?>" class="title"><?php echo($doc['name_tam']) ?></a></h3>
                        <h6><a href="psa-document.php?d=<?php echo($doc['id']) ?>" class="description"><?php echo($catD['cat_name_tam']) ?></a></h6>
                    </div>
                </div>
                <?php
            }
        ...
        for ($i = 0; $i < $num2; $i++) {
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog">
                    ...
                    <h4 class="blog-title"><a
                            href="single-blog.php?n=<?php echo ($blog['id']) ?>"><?php echo ($blog['title_tam']) ?></a>
                    </h4>
        ...
        <div class="col-lg-6  text-center">
            <ul class="pagination d-flex justify-content-center align-items-center text-center">
                ...
                if ($pageno <= 1) {
                    ...
                    ?>
                    onclick="loadBlogTam(<?php echo ($pageno - 1) ?>)" ; <?php
                }
                ?>><<</a></li>
                ...
                for ($y = 1; $y <= $num_of_pages; $y++) {
                    if ($y == $pageno) {
                        ...
                        ?>
                        <li class="page-item active">
                            <a class="page-link" onclick="loadBlogTam(<?php echo ($y) ?>);"><?php echo ($y) ?></a>
                        </li>
                        <?php
