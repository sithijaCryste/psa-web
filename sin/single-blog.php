...
<head>
    ...
    <meta property="og:image" content="https://www.psallaince.lk/admin/<?php echo htmlspecialchars($data['path']); ?>">
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta charset="UTF-8" />
    <title><?php echo htmlspecialchars($data['title_sin']); ?> - PSA</title>
    ...
    <nav class="navbar navbar-expand-lg bg-danger sticky-top">
        <div class="container-fluid">
            ...
            <ul class="list-group list-group-horizontal bg-danger">
                ...
                <li class="list-group-item bg-danger"><a class="" href="../tam/blog.php">தமிழ்</a></li>
            </ul>
        </div>
    ...
    <section class="blog-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="blog-post">
                        <h1 class="blog-title"><?php echo htmlspecialchars($data['title_sin']); ?></h1>
                        <div class="row">
                            <ul class="social-u ">
                                <li class="">
                                ...
                                <li class="">
                                    <a href="https://www.facebook.com/dialog/share?link=<?php echo ($url); ?>&text=Hi!%0AThere%20is%20something%20may%20interesting%20you:%0A<?php echo($data['title_sin']) ?>A"><i class="fa-brands fa-facebook-messenger icon"></i></a>
                                </li>
                                <li class="">
                                    <a href="https://wa.me/?text=<?php echo urlencode("Hi! Check this out: " . $data['title_sin'] . " " . $url); ?>" target="_blank"><i class="fa-brands fa-whatsapp icon"></i></a>
                                </li>
                                <li class="">
                                    <a href="https://t.me/share/url?url=<?php echo urlencode($url); ?>&text=Hi!%0AThere%20is%20something%20may%20interesting%20you:%0A<?php echo($data['title_sin']) ?>%0A"><i class="fa-brands fa-telegram icon"></i></a>
                                </li>
                                <li class="">
                                    <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode("Hi! Check this out: " . $data['title_sin'] . " " . $url); ?>" target="_blank"><i class="fab fa-twitter icon"></i></a>
                                </li>
                                <li class="">
                                    <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode($url); ?>&title=<?php echo($data['title_sin']) ?>"><i class="fab fa-linkedin-in icon"></i></a>
                                </li>
                                <li class="">
                                <a href="mailto:?subject=[Latest News PSA]&body=[Hi!%0AThere%20is%20something%20may%20interesting%20you:%0<?php echo($data['title_sin']) ?>%0A<?php echo urlencode($url); ?>]"><i class="fa-solid fa-envelope icon"></i></a>
                            </li>
                            <li class="">
