...
$q = "SELECT * FROM `news` WHERE `news`.`header` LIKE '%$news%' OR `news`.`content` LIKE '%$news%' ORDER BY `date` DESC";
...
if ($num2 == 0) {
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog">
                    ...
                    <h4 class="blog-title"><a
                            href="single-news.php?n=<?php echo ($news['id']) ?>"><?php echo ($news['header']) ?></a>
                    </h4>
                    <p class="blog-meta"><?php echo ($news['date']) ?></p>
                    <p class="truncateNews"><a href="single-news.php?n=<?php echo ($news['id']) ?>"><?php echo ($news['content']) ?></a></p>
    ...
    $q = "SELECT * FROM `document` WHERE `document`.`name` LIKE '%$document%' ORDER BY `date` DESC";
            ...
            for ($i = 0; $i < $num2; $i++) {
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="serviceBox boxHov">
                        ...
                        <h3><a href="psa-document.php?d=<?php echo($doc['id']) ?>" class="title"><?php echo($doc['name']) ?></a></h3>
                        <h6><a href="psa-document.php?d=<?php echo($doc['id']) ?>" class="description"><?php echo($catD['cat_name']) ?></a></h6>
                    </div>
                </div>
                <?php
            }
