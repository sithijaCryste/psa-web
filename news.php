...
<head>
    ...
    <meta name="keywords" content="People's Struggle Alliance, PSA, political left, socialism, communism, social justice, equality, working class, political movement, progressive politics, psallaince, people' struggle, struggle, sri lanka, news, struggle news, ජන අරගල සන්ධානය, අරගල, අරගල පක්ෂය, ජනතා පක්ෂය ">
...
<body data-spy="scroll" data-target=".navbar-nav" onload="loadNews(0)">
    <!-- Preloader -->
    <div id="preloader">
        <div class="spinner">
